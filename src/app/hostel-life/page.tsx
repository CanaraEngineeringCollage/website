...
export const metadata = {
  ...
  openGraph: {
    ...
    url: "https://cec.edu.in/hostel-life", // Update with the actual URL
    siteName: "Canara College",
    images: [
      {
        url: "https://cec.edu.in/og-hostel-life.jpg", // Update image URL
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://cec.edu.in/og-hostel-life.jpg"], // Update image URL
  },
};
