...
export const metadata = {
  ...
  openGraph: {
    title: "Research | Canara College",
    description:
      "Explore research work at Canara College, featuring innovative projects, impactful publications, and faculty & student contributions.",
    url: "https://cec.edu.in/academics/research", // update this
    siteName: "Canara College",
    images: [
      {
        url: "https://cec.edu.in/og-research.jpg", // update this
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://cec.edu.in/og-research.jpg"], // update this
  },
};
const page = () => {
  return (
