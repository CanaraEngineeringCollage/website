...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: "/programs", priority: 0.9 }, // High intent for students
    ...
    { url: "/about-cec", priority: 0.8 },
    { url: "/student-achievements", priority: 0.8 },
    { url: "/alumni", priority: 0.8 },
    { url: "/academic-overview", priority: 0.8 },
    { url: "/cif", priority: 0.8 },
    { url: "/entrepreneurship-cell", priority: 0.8 },
    { url: "/infrastructure", priority: 0.8 },
    { url: "/hostel-life", priority: 0.7 },
    { url: "/studentlife-engagement", priority: 0.7 },
    { url: "/research-development-consultancy", priority: 0.7 },
    { url: "/central-library", priority: 0.7 },
    { url: "/physical-education", priority: 0.7 },
    { url: "/research", priority: 0.7 },
    { url: "/learning-hub", priority: 0.7 },
    { url: "/examination-records", priority: 0.7 },
    // Lower priority utility/about pages
    { url: "/mandatory-disclosure", priority: 0.6 },
    { url: "/distinctive-practices", priority: 0.6 },
    { url: "/educators-administrators", priority: 0.6 },
    { url: "/governing-council", priority: 0.6 },
    { url: "/our-management", priority: 0.6 },
    { url: "/our-founder", priority: 0.6 },
    { url: "/key-functionaries-and-hods", priority: 0.6 },
    { url: "/student-welfare-department", priority: 0.6 },
    { url: "/central-library/about-library", priority: 0.6 },
    { url: "/alumni/about-alumni", priority: 0.6 },
    { url: "/history-of-cec", priority: 0.5 },
    { url: "/grievance-redressal-cell", priority: 0.5 },
    { url: "/mandatory-disclosure/sc-st-grievance", priority: 0.5 },
