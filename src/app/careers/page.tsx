    ...
    <section className="py-10 px-5 text-[#1D1D1F] xl:py-20 pb-10 max-w-7xl xl:max-w-[75%] mx-auto">
      <div className=" space-y-8">
        ...
        <h1 className="text-3xl md:w-[90%] md:text-[40px] lg2:text-5xl xl:text-6xl font-bold leading-[1.2] text-[#1D1D1F]">
          Faculty Recruitment 2025–26
        </h1>

        {/* Intro paragraph */}
        <p className="text-textGray text-[17px] leading-relaxed">
          Canara Engineering College, established as the millennium project of
          Canara High School Association in 2001, has most of its conventional
          courses accredited by NBA. NAAC accreditation with A grade – CGPA 3.24
          has further accentuated the innovative applications aimed at enhancing
          student skills through Outcome Based Education system, training, and
          research innovation.
        </p>
        ...
        <div className="space-y-4">
          <p className="text-textGray text-[17px]">
            Applications are invited from eligible candidates for the faculty
            positions in the following programs:
          </p>
        ...
        <div className="space-y-2">
          ...
          <ul className="list-square pl-6 text-textGray text-[17px] space-y-1">
            ...
            <li>
              Intimation for interview will be sent to eligible and shortlisted
              candidates.
            </li>
        ...
        <p className="text-[17px] text-textGray">
          ...
          <Link
            ...
            className="text-[#2884CA] hover:underline"
          >
            canarait@gmail.com
          </Link>
        </p>
