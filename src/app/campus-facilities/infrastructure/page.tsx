...
export const metadata = {
  ...
  openGraph: {
    title: "Infrastructure | Canara College",
    description:
      "Discover the infrastructure at Canara College, featuring modern facilities and resources that enhance the student experience.",
  ...
  twitter: {
    ...
    title: "Infrastructure | Canara College",
    description:
      "Explore the infrastructure and modern facilities at Canara College that support an enriching academic environment.",
