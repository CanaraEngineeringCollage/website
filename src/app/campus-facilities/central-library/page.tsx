...
const AboutTheDepartment = () => {
  ...
  md:text-[40px] text-3xl lg2:text-5xl xl:text-6xl `}
          ...
          <div className="hidden lg:block ">
            <Link href="/campus-facilities/central-library/about-library">
              <button className="bg-[#007AFF26] hover:bg-blue-200 rounded-4xl lg:px-4 mt-3.5 lg:py-2.5">
      ...
      {aboutTheDepartment?.map((paragraph, index) => (
        <p
          key={index}
          className="text-textGray text-justify text-[20px] mt-10 mb-4"
        >
          {paragraph}
        </p>
      ))}
      <div className="flex justify-center mt-10 lg:hidden">
        <Link href="/campus-facilities/central-library/about-library">
          <button className="bg-[#007AFF26] hover:bg-blue-200 rounded-4xl px-6 py-2.5">
            More About the Library
          </button>
        </Link>
      </div>
