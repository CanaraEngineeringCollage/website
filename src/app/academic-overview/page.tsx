...
export const metadata = {
  ...
  openGraph: {
    ...
    url: "https://cec.edu.in/academic-overview",
    siteName: "Canara College",
    images: [
      {
        url: "https://cec.edu.in/og-academic-overview.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://cec.edu.in/og-academic-overview.jpg"],
  },
};
...
const page = () => {
  return (
    <>
      ...
      <section className=" pt-28   xl:px-0">
        <ExplorePrograms />
      </section>
      <section className="px-6 mt-10 md:px-12 lg:px-16 xl:px-0">
        <EmpoweringFutures />
      </section>
      <section className="pb-20 md:px-6 lg:px-0 pt-14">
        <VideoPlayer
