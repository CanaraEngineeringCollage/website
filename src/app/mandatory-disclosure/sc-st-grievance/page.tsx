...
export const metadata = {
  alternates: {
    canonical: "/mandatory-disclosure/sc-st-grievance",
  },
  ...
  openGraph: {
    ...
    url: "https://cec.edu.in/mandatory-disclosure/sc-st-grievance", // update this
    siteName: "Canara Engineering College",
    images: [
      {
        url: "https://cec.edu.in/og-sc-st-grievance.jpg", // update this
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "SC/ST Grievance Cell | Canara Engineering College",
    description: "Understand the functions of the SC/ST Grievance Cell at Canara Engineering College and its commitment to equality and support.",
    images: ["https://cec.edu.in/og-sc-st-grievance.jpg"], // update this
  },
};
