...
const BuildingStrength = () => {
  return (
    <div className="max-w-7xl mx-auto  xl:max-w-[75%] text-center py-10 lg:pt-20 pb-8 text-[#1D1D1F]">
      ...
      <p className="lg:text-xl md:text-lg text-[14px] leading-7 pt-5 md:pt-10 text-textGray">
