    ...
    <section className="bg-[#fafbfe] py-10 lg:py-20 md:px-4 lg:px-4 lg2:px-4  ">
      <div className="max-w-7xl xl:max-w-[75%] mx-auto">
        <div className="flex flex-col md:flex-row items-start gap-12">
          {/* Left Column - Text */}
          <div className="flex-1  text-textGray text-[17px] leading-relaxed space-y-6 ">
            ...
            <p className="px-4 md:px-0 text-justify">
          ...
          <div className=" hidden md:flex flex-col items-center flex-shrink-0 mx-auto lg:px-20">
            <div className="w-70 h-[10rem]  lg:h-[20rem] md:h-[26rem] relative rounded-xl overflow-hidden shadow-md">
        ...
        <div className="text-textGray text-[17px] leading-relaxed  space-y-6 pt-5">
          <p className="px-4 md:px-0 text-justify">
