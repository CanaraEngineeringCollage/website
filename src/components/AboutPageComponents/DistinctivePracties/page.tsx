...
const DistinctivePracties = () => {
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-7xl w-full justify-center">
    {practices.slice(0, 3).map((item) => (
      <div
        key={item.id}
        className="bg-white p-6 sm:p-10 md:p-12 lg:p-16 rounded-md w-full max-w-[397px] h-auto min-h-[180px] md:min-h-[200px] lg:min-h-[216px] flex items-center justify-center text-center border border-[#2884CA] transition-colors duration-300 mx-auto"
      >
