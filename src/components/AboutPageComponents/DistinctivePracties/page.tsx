  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col items-center px-4 sm:px-6 md:px-12 pb-12 bg-white overflow-hidden">
        {/* Title */}
        <h2 className="text-[#1D1D1F] text-3xl sm:text-3xl md:text-[54.14px] font-bold text-center mt-6 lg:mt-0 mb-3">
          Distinctive Practices
        </h2>

        {/* Subtitle */}
        <p className="text-textGray text-center max-w-4xl mb-10 text-lg md:text-[20.34px]">
      ...
      <div className="w-full bg-[#F1F3FB] flex justify-center px-4 sm:px-8 md:px-12 lg:px-[6rem] py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-[1300px]">
          ...
          <div className="bg-white border rounded-xl shadow-sm p-6 sm:p-8">
            ...
            <ul className="list-disc  space-y-3 text-textGray text-lg md:text-[17px] leading-relaxed">
