  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col items-center px-6 py-12 bg-white">
        {/* Title */}
        <h2 className="text-[#1D1D1F] text-2xl md:text-[54.14px] font-bold text-center mb-3">
          Distinctive Practices
        </h2>

        {/* Subtitle */}
        <p className="text-[#86868B] text-center max-w-4xl mb-10 text-sm md:text-[20.34px]">
        ...
        {/* First Row (3 Cards) */}
        <div className="grid grid-cols-1 md:grid-cols-3 max-w-7xl w-full justify-center">
          {practices.slice(0, 3).map((item) => (
            <div
              key={item.id}
              className="bg-white p-16 rounded-md w-[397px] h-[216px] flex items-center justify-center text-center border border-[#2884CA] transition-colors duration-300"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 max-w-4xl w-full justify-center mt-10">
      ...
      <div className="">
        <div className="w-full bg-[#F1F3FB] flex justify-center px-[6rem] py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 min-w-[613px] min-h-[598px]">
            {/* Faculty Centric Practices */}
            <div className="bg-white border rounded-xl shadow-sm p-8">
              <h3 className="text-xl text-[#1D1D1F] md:text-[36px] font-bold mb-6">Faculty Centric Practices</h3>
              <ul className="list-square list-inside space-y-3 text-[#86868B] text-base md:text-[17px]">
            ...
            <div className="bg-white border rounded-xl shadow-sm p-8">
              <h3 className="text-xl text-[#1D1D1F] md:text-[36px] font-bold mb-6">Student Centric Practices</h3>
              <ul className="list-square list-inside space-y-3 text-[#86868B] text-base md:text-[17px]">
