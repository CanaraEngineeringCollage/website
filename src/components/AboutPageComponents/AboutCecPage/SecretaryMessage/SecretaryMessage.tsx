...
const SecretaryMessage = () => {
  ...
  <div className=" py-16  md:py-20 lg:py-24">
     <h1 className="text-2xl text-center lg:hidden lg:text-start  md:text-[40px] lg:text-5xl xl:text-6xl font-bold leading-snug lg:leading-[1.1] text-white mb-6 ">
          Message from the <br /> Honorary Secretary
        </h1>
    <div className="grid grid-cols-1 lg:w-[73%] overflow-hidden mx-auto lg:grid-cols-12  items-center">
