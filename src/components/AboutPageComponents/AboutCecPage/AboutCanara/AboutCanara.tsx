...
const AboutCanara = () => {
  return (
    <div className="max-w-5xl mx-auto xl:max-w-[65%] text-justify pt-20 text-black">
      ...
      <h1 className="text-3xl md:text-[40px] lg2:text-5xl text-[#1D1D1F] xl:text-6xl text-center font-bold">A Campus Like No other</h1>
      ...
      <p className="lg:text-xl md:text-lg text-[14px] leading-7 pt-12 text-textGray">
        Campus placement statistics are encouraging with nearly 90% of the eligible students getting placed in CSE & allied branches, with a median
        salary of 7 lakhs and highest CTC of 17 to 24 lakhs. Reputed DST and other agency funded, a few R&D Projects are being executed in the
        institute. Active Academic tie-ups with some industries & universities like Infosys, Ace-Micromatic, ICT Academy, Niveus, Nitte University,
        MAHE-Manipal School of Information Sciences, Q-Spiders, Kakunje Softwares, Ethnus etc. are helping the students and faculty towards getting
        exposed to latest technical know-how and hands-on experiences. Motivated and well guided faculty are into research activity, with increasing
