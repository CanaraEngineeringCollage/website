...
export default function AboutCanara() {
  ...
  return (
    <div ref={contentRef} className="max-w-7xl mx-auto xl:max-w-[75%] text-justify  text-black">
        ...
        >
          <div className="overflow-hidden">
            <p className="lg:text-xl text-lg  text-justify leading-7 pt-6 text-textGray">
              ...
              **autonomous institution, CEC now has the academic freedom to design innovative curricula aligned with **emerging industry needs,
              ensuring students are future-ready. We take pride that all eligible B.E. programs are accredited by the **National Board of
              Accreditation (NBA)* and the institution itself is accredited by *NAAC with an “A” grade (CGPA 3.24)*.
            </p>
            <p className="lg:text-xl text-lg  leading-7 pt-6 text-textGray">
              ...
              line with national standards. Around 35% of our students reside in modern, eco-friendly hostels on campus. Our students consistently
              excel in academics, securing *university ranks, gold medals, and 100% results* in leading branches, while also achieving national-level
            ...
            <p className="lg:text-xl text-lg  leading-7 pt-6 text-textGray">
              ...
              *Entrepreneurship Development Cell (EDC)* nurtures innovation and startups. With strong industry partnerships and academic tie-ups
              including Infosys, Ace Micromatic, ICT Academy, Niveus, MAHE, Q-Spiders, Ethnus, and more CEC bridges the gap between academia and
              industry.
            </p>
            ...
            <p className="lg:text-xl text-lg  leading-7 pt-6 text-textGray">
              CEC continues to expand its infrastructure and learning opportunities, staying in step with the demands of *Industry 4.0* and beyond.
              With a perfect balance of tradition, innovation, and excellence, Canara Engineering College is not just an institution it’s a launchpad
              for *tomorrow’s engineers, innovators, and leaders*{" "}
            </p>
          </div>
        </div>
      </div>
