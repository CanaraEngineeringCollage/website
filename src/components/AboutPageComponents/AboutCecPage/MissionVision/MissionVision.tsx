...
export default function MissionVision() {
  return (
      <div className="max-w-7xl md:pt-14 pt-5 pb-16 lg:pb-20 xl:max-w-[75%] mx-auto grid grid-cols-1 lg:grid-cols-12 lg:gap-20">
        {/* Mission Card */}
         <div className="bg-white col-span-5  lg:mt-0 rounded-2xl shadow p-8 flex flex-col items-center justify-center text-center space-y-6">
        ...
        <div className="bg-white col-span-7 mt-10 lg:mt-0 overflow-hidden rounded-2xl shadow p-10 lg:p-18 space-y-6">
