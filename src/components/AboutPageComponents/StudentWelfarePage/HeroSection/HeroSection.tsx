...
import bgImage from "../../../../../public/studentWelfarePage/heroImage.webp";
    ...
    <section className="relative w-full h-[60vh] md:h-[70vh]  flex flex-col justify-center items-center text-center px-4 overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-0 left-0 w-full h-[40%] bg-gradient-to-b from-black/60 to-transparent z-10" />
               <div className="absolute bottom-0 left-0 right-0 h-[100px] md:h-[1000px] bg-gradient-to-t from-[#fcfdff]  via-transparent to-transparent z-[10] md:hidden" />
               <div className="absolute bottom-0 left-0 right-0 h-[500px] md:h-[150px] bg-gradient-to-t from-[#fcfdff]  to-transparent z-[10] hidden md:block" />
      </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[50px] bg-gradient-to-t from-[#fcfdff] via-transparent to-transparent z-[10] md:hidden" /> 
        <div className="absolute bottom-0 left-0 right-0 h-[50px] bg-gradient-to-t from-[#fcfdff] via-transparent to-transparent z-[10] md:hidden" /> 
        <div className="absolute bottom-0 left-0 right-0 h-[50px] bg-gradient-to-t from-[#fcfdff] via-transparent to-transparent z-[10] md:hidden" /> 
