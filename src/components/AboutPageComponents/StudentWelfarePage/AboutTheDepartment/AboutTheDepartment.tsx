...
const AboutTheDepartment = () => {
  return (
    <section className="md:pt-20 xl:pt-44  max-w-8xl xl:max-w-[90%] mx-auto text-[#1D1D1F] lg:px-32">
      <div className="">
        <h1 className="text-3xl md:text-[40px] lg2:text-5xl xl:text-6xl  font-bold text-[#1D1D1F] pb-5 ">About the Department</h1>
        ...
        <h1 className="text-3xl text-start md:text-[40px] lg2:text-4xl pt-5 pb-3 xl:text-6xl font-bold">Department vision</h1>
        <p className="text-textGray text-justify text-[20px]">
        ...
        <h1 className="text-3xl text-start md:text-[40px] pt-5 pb-3 lg2:text-4xl xl:text-6xl font-bold">Department Mission </h1>
