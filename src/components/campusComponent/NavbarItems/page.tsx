...
function NavbarItems() {
  ...
  return (
    ...
    <div className="hidden nav-items lg:flex text-secondary lg2 flex-row space-x-3 xl:space-x-6">
      ...
      <div
        id="apply"
        className="pt-[8px] font-poppins text-base xl:text-base font-semibold transition duration-300 ease-in-out h-20 flex items-center justify-center"
      ...
      <div  className="pt-[8px] font-poppins text-base xl:text-base font-semibold transition duration-300 ease-in-out h-20 flex items-center justify-center">
