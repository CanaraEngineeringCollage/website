...
export default function AlumniMentorshipAndEvents() {
  return (
    <section className="max-w-7xl mx-auto xl:max-w-[75%] ">
            ...
            >
              {data.map((item) => (
                <SwiperSlide key={item.id}>
                  <div className="relative">
                    <Image src={item.imageSrc} alt={item.title} width={1000} height={1000} className="w-full h-full object-cover rounded-3xl" />
