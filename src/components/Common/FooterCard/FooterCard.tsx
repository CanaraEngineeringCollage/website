      ...
      >
        <div className="text-center py-13  px-12 lg:px-36">
          ...
          <button aria-label="Book Your Counselling Session Today"
           onClick={()=>setIsOpen(true)} className="text-[#2884CA] cursor-pointer text-[10px] lg:text-[20px] lg:px-5 px-3 lg:py-3 py-2 bg-white rounded-4xl">Book Your Counselling Session Today</button>
        </div>
      </div>
