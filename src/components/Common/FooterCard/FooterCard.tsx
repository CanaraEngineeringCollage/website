    ...
    <section className="py-36">
      <div className="max-w-6xl mx-auto bg-[#2474b3]  rounded-2xl">
        <div className="text-center py-13 px-3  lg:px-36">
          <h1 className="text-[47px] text-[#FFFFFF] leading-[1.2] pb-2">Ready to take the next step?</h1>
          <p className="text-[20px] text-[#99c2e0] pb-4">
            Book a one-on-one <span className="text-[#FFFFFF]">counselling session</span> & get all your questions answered about admissions, programs
