    ...
    <section className="py-10 px-4 sm:px-8 md:px-16 lg:px-32">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 lg:gap-16">
        <div className="md:col-span-3">
          <Image src="/userPersonsImage/1.jpg" width={100} height={100} alt="userperson" className="w-full h-auto object-cover rounded-lg" />
        </div>
        <div className="md:col-span-9">
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm w-full">
            ...
            <div className="flex flex-wrap gap-2 mt-4">
              <button aria-label="Pressure-Driven" className="px-3 py-1 bg-gray-200 text-gray-700 text-sm">
                Pressure-Driven
              </button>
              <button aria-label="Pressure-Driven" className="px-3 py-1 bg-gray-200 text-gray-700 text-sm">
                Competitive
              </button>
              <button aria-label="Curious" className="px-3 py-1 bg-gray-200 text-gray-700 text-sm">
                Curious
              </button>
              <button aria-label="Tech-Savvy" className="px-3 py-1 bg-gray-200 text-gray-700 text-sm">
                Tech-Savvy
              </button>
            </div>
        ...
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
            <div className="text-center p-4 bg-white shadow rounded-lg">
              ...
              <p className="text-[#1D1D1F] text-sm sm:text-base font-medium">Pursue a field with strong career prospects</p>
            </div>
            <div className="text-center p-4 bg-white shadow rounded-lg">
              <Image src="/svgs/common/2.svg" alt="Cogwheel" width={50} height={50} className="mx-auto mb-2" />
              <p className="text-[#1D1D1F] text-sm sm:text-base font-medium">Achieve success in technology & innovation</p>
            </div>
            <div className="text-center p-4 bg-white shadow rounded-lg">
              <Image src="/svgs/common/1.svg" alt="Money Bag" width={50} height={50} className="mx-auto mb-2" />
              <p className="text-[#1D1D1F] text-sm sm:text-base font-medium">Secure a high-paying & stable profession</p>
            </div>
          </div>
        </div>
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg w-full">
        ...
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg w-full">
          <div className="flex flex-col md:flex-row justify-between">
            ...
            <div className="md:w-1/2 md:ml-6 mt-6 md:mt-0">
              ...
              <ul className="space-y-3 text-[#1D1D1F] text-sm sm:text-base">
                {[
