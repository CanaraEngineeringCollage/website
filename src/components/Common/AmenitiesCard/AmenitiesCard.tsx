    ...
    <section className="max-w-7xl xl:max-w-[75%] mx-auto py-20 overflow-hidden text-black">
      <div>
        ...
        <div className="relative">
          ...
          <div className="absolute mx-6 lg:mx-12 top-[150px] lg:top-[270px] left-0 w-full h-full flex justify-center flex-col">
            <h1 className="text-white lg:text-[40px] text-[21px] text-start font-bold">{mainImage.title}</h1>
            <p className="text-white lg:text-[20px] text-[14px] me-10">{mainImage.description}</p>
          </div>
        </div>
          ...
          {amenities.map((amenity, index) => (
            <div key={index} className="col-span-4">
              <div className="relative">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent rounded-3xl"></div>
                <div className="absolute mx-6 top-[140px] left-0 w-full h-full flex justify-center flex-col">
