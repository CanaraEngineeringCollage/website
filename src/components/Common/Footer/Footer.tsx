        ...
        <Suspense fallback={null}>
          ...
          <Breadcrumbs
            items={[
              ...
              { label: "Computer Science & Engineering", href: "/department/computer-science-engineering/details" },
              { label: "Computer Science & Engineering", href: "/department/computer-science-engineering" },
              { label: "Artificial Intelligence & Machine Learning", href: "/department/artificial-intelligence-machine-learning/details" },
              { label: "Artificial Intelligence & Machine Learning", href: "/department/artificial-intelligence-machine-learning" },
              { label: "Information Science & Engineering", href: "/department/information-science-engineering/details" },
              { label: "Information Science & Engineering", href: "/department/information-science-engineering" },
              { label: "Electronics & Communication Engineering", href: "/department/electronics-communication-engineering/details" },
              { label: "Science & Humanities", href: "/department/science-humanities/details" },
              ...
              { label: "Computer Science & Business System", href: "/department/computer-science-business-system/details" },
              ...
              { label: "Computer Science & Design", href: "/department/computer-science-design/details" },
