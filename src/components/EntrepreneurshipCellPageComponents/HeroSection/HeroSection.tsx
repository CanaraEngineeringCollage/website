...
const HeroSection = () => {
  return (
    <section className="relative w-full h-[80vh]  lg:h-[100vh]  flex flex-col justify-center items-center text-center px-4 overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-[100px] md:h-[200px] bg-gradient-to-t from-[#fbfcfe] via-white/85 via-50% to-transparent z-[10] md:hidden" />
 ...
 <div className="absolute top-[20%] lg:top-1/2  -translate-y-1/2 flex flex-col space-y-4 sm:space-y-6 px-1 sm:px-6 md:px-10 lg:px-[4rem] z-10 text-center lg:text-start text-white 
  ...
  <h3 className="text-[#F5F5F7]/70   min-w-xs text-[20px] md:text-[25px] lg:text-[31px] leading-6 sm:leading-8 md:leading-10 lg:leading-none">
