...
const IdeasText = () => {
  return (
    <div className="max-w-7xl mx-auto lg:px-36 xl:max-w-[75%] text-center pt-20 text-[#1D1D1F]">
      ...
      <p className="lg:text-xl text-start md:text-lg text-[14px] leading-7 pt-2 pb-10 text-textGray">
      ...
      <img src="https://www.canaraengineering.in/assets/images/e1.jpg" alt="" className="pt-2 pb-10" />
    </div>
  );
};
