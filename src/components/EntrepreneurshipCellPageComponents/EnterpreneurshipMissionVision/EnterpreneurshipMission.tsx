export default function EnterpreneurshipMission() {
  return (
    <div className="max-w-7xl mx-auto  xl:max-w-[75%] pt-5 pb-12 md:py-20 lg:py-16  text-[#1D1D1F]">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 md:p-10 lg:px-12">
            ...
            <ul className="space-y-6 sm:space-y-8">
              <li className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4 sm:gap-10 lg:gap-12">
                <img src="/aboutPageImages/MissionVision/visionImage1.webp" alt="icon" className="w-12 sm:w-[50px] md:w-[59px] h-auto" />
                <p className="text-textGray text-sm sm:text-base leading-relaxed">
              ...
              <li className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4 sm:gap-10 lg:gap-12">
                <img src="/aboutPageImages/MissionVision/visionImage2.webp" alt="icon" className="w-12 sm:w-[50px] md:w-[59px] h-auto" />
                <p className="text-textGray text-sm sm:text-base leading-relaxed">
              ...
              <li className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4 sm:gap-10 lg:gap-12">
                <img src="/aboutPageImages/MissionVision/visionImage3.webp" alt="icon" className="w-12 sm:w-[50px] md:w-[59px] h-auto" />
                <p className="text-textGray text-sm sm:text-base leading-relaxed">
