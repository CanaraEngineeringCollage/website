  ...
  return (
    <section className="max-w-7xl xl:max-w-[75%] mx-auto py-16 lg:pb-16 lg:pt-20 text-[#1D1D1F]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 lg:grid-rows-3 gap-6 lg:[grid-auto-rows:1fr]">
        {/* Left Column */}
        {[
          { title: "Premier Hiring Partners", subtitle: "Median Salary", description: "Offered to Top 5% of Student Candidates" },
        ...
        {/* Right Column */}
        {[
          { title: "100%", subtitle: "Internship Completion Rate", description: "(from 98% existing)" },
