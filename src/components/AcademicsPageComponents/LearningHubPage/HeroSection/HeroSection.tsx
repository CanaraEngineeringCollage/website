...
const HeroSection = () => {
  return (
    <section className="text-[#1D1D1F] relative w-full overflow-hidden pb-28">
      <div className="relative h-[90vh] lg:h-[120vh] w-[100vw] flex justify-center items-center">
        <Image src="/backgroundImages/1.webp" alt="" width={1000} height={1000} className="object-cover object-top md:object-center w-full h-full" />
