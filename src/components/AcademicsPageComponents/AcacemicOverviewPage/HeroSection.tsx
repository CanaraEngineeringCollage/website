...
import bgImage from "../../../../public/academicPageImages/heroImage.webp";
...
const HeroSection = () => {
  return (
    <section className="relative w-full h-[85vh]  lg:h-[130vh]  flex flex-col justify-center items-center text-center px-4 overflow-hidden">
      ...
      <div className="absolute top-20 md:top-24 space-y-6  mx-auto text-white px-4 z-10">
        ...
        {/* <h2 className="text-[23px] md:text-[40px]  lg:text-[77px] leading-[30px] md:leading-10 lg:leading-[1.1] font-bold text-white">
