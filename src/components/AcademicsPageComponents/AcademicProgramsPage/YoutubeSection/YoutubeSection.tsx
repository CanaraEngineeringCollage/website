...
const YoutubeSection: React.FC<YoutubeSectionProps> = ({ title }) => {
  return (
    <section className="px-6 md:px-12 lg:px-16 xl:px-0 max-w-7xl mx-auto xl:max-w-[75%]">
      {title && <h1 className="text-black mb-10 text-center text-3xl md:text-[40px] lg2:text-5xl xl:text-6xl font-bold">{title}</h1>}
