...
import bgImage from "../../../../../public/campusFacilitiesPageImages/studentLifePageImages/Life at Canara.webp";
...
<p className="text-[16px] lg:text-[21px] mx-3 text-[#fbfcfe] lg:max-w-[48%]">A brief overview highlighting the dynamic student life, fostering academic growth, innovation, & community engagement.</p>
 ...
 <div className="absolute bottom-0 left-0 right-0 h-[500px] md:h-[150px] bg-gradient-to-t from-[#fbfcfe]  to-transparent z-[10] hidden md:block" />
