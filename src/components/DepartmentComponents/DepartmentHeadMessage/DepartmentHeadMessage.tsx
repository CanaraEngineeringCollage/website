  ...
  return (
    <section className="w-full bg-[#051B2C]">
      <div className=" py-16  md:py-20 lg:py-20">
          <h1 className="text-3xl lg:hidden text-center lg:text-start mb-10 md:text-[40px] leading-[1.2] lg2:text-5xl  font-bold">Message from the Head of the Department</h1>
