...
interface DepartmentHeadMessageProps {
  ...
  return (
    <section className="max-w-8xl xl:max-w-[75%] mx-auto py-24 my-24">
      <div className=" grid  lg:grid-cols-2 lg:gap-26 lg:px-10 xl:px-40">
        ...
        <div>
          <div className="hidden lg:flex flex-col ms-22 items-center flex-shrink-0 mx-auto ">
