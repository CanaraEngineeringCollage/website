...
export default function LegacyExcellance() {
  ...
  useEffect(() => {
    ...
    if (isPlaying) {
      ...
      }, 30); // Controls the speed of progress
    } else if (timer) {
      clearInterval(timer);
    }
      ...
      <div className="grid grid-cols-1 gap-8 lg2:gap-16 items-start">
        ...
        <div className="relative w-full">
          <div className="relative">
            ...
            <div className="mt-22 cursor-pointer" onClick={toggleCarousel}>
              <svg width="50" height="50" viewBox="0 0 50 50">
                ...
                <foreignObject x="8" y="8" width="34" height="34">
                  <button className="w-full h-full flex items-center justify-center bg-none cursor-pointer" aria-label={isPlaying ? "Pause" : "Play"}>
                    {isPlaying ? (
