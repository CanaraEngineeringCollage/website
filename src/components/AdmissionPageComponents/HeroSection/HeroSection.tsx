  ...
  return (
    <section className="relative w-full h-[90vh] lg:h-screen overflow-hidden">
      ...
      <Image
        src={bgImage}
        alt="Hero Background"
        className="absolute inset-0 w-full h-full object-cover lg:object-center md:object-[80%_center] object-[80%_center] "
        priority
      />
      ...
      <div className="relative z-10 max-w-[850px] px-6 md:px-20 top-[5%] lg:top-[25%]">
        ...
        <p className="text-[#CDE5FF] text-[16px] pe-10 leading-[1.3] md:text-[31px] mt-2">
          Begin your engineering  <br className='md:hidden'/> journey with a  <br className='md:hidden'/> foundation-built curriculum.
        </p>
